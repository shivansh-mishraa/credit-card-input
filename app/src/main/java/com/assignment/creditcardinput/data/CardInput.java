package com.assignment.creditcardinput.data;
...
public class CardInput {
    ...
    public CardInput(String creditCardNumber, String expirationDate, String cvv, String firstName, String lastName) {
    ...
    public static boolean isValidCardNumber(String cardNumber) {
        // here we have putting the Luhn Alogrithm
    ...
    private static boolean luhnValidation(String cardNumber) {
        // Alorithm starts from here taken help from this
